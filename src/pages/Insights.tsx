          ...
          <div className="w-full lg:w-2/3 flex flex-col relative h-full">
            <div className="flex-1 relative overflow-x-hidden bg-white border border-gray-200 group hover:border-gray-200 transition-colors min-h-[500px]">
              <AnimatePresence mode="wait">
                ...
                >
                  <div>
                    <span className="font-sans text-[#C8102E] text-[10px] tracking-widest uppercase mb-4 block">{lhsArticles[lhsIndex].tag}</span>
                    ...
                    <p className="text-gray-500 text-sm md:text-base max-w-3xl mb-8">
                      {lhsArticles[lhsIndex].desc}
                    </p>
                    
                    {lhsArticles[lhsIndex].type === 'chart' ? (
                      <div className="mb-12">
                        <YieldChart />
                      </div>
                    ) : (
          ...
          <div className="w-full lg:w-1/3 flex flex-col relative h-full">
            <div className="flex-1 relative overflow-x-hidden bg-white border border-gray-200 group hover:border-gray-200 transition-colors min-h-[500px]">
              <AnimatePresence mode="wait">
                ...
                >
                  <div>
                    <span className="font-sans text-[#C8102E] text-[10px] tracking-[0.3em] uppercase mb-6 block">{rhsArticles[rhsIndex].tag}</span>
