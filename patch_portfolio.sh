...
export function Portfolio() {
  return (
    <section id="portfolio" className="py-32 w-full bg-[#FFFFFF]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            ...
            <h2 className="font-sans font-bold text-4xl md:text-5xl text-black tracking-tighter">
              {data.portfolioSection.header.title}
            </h2>
          </div>
          <a
            href={data.portfolioSection.header.link.href}
            className="flex items-center gap-2 text-[10px] font-sans font-bold tracking-[0.2em] uppercase text-[#C8102E] hover:text-[#C8102E] transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-32">
          {data.portfolioSection.projects.map((project, idx) => (
            <motion.div
              ...
              className="group relative block overflow-hidden bg-[#FFFFFF] border border-gray-200"
            >
              ...
              <div className="p-8 relative z-20">
                ...
                <h3 className="font-sans font-bold text-2xl text-black mb-2 tracking-tight">
                  {project.title}
                </h3>
